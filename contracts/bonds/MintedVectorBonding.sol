...
contract MintedVectorBonding {
    ...
    uint256 public tokensForPayout;
    ...
    function initializeBond(
        ...
        tokensForPayout = VEC.balanceOf(address(this));
        bondType = _bondType;
    ...
    function withdrawStuckToken(
        ...
        if (_token == address(VEC)) {
            require(tokensForPayout >= _amount, "Can only withdraw tokens not given for payout");
            tokensForPayout = tokensForPayout.sub(_amount);
        }
    ...
    function deposit(
        ...
        tokensForPayout = tokensForPayout.sub(payout);
